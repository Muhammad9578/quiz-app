...
import 'package:quiz_app_flutter/app/modules/teacher_dashboard/views/teacher_scoreboard.dart';
...
class SettingPage extends StatelessWidget {
  ...
  SettingPage({super.key, required this.teacherDashboardController});
            ...
            children: [
              ...
              ListTile(
                ...
                title: PrimaryTextField(
                    controller: teacherDashboardController.updatename.value,
                      ...
                      try {
                        if (teacherDashboardController
                          ...
                          await userDocRef.update({
                            'name':
                                teacherDashboardController.updatename.value.text
                          });

                          teacherDashboardController.userData.value!["name"] =
                              teacherDashboardController.updatename.value.text;
                          teacherDashboardController.userData.refresh();
              ...
              ListTile(
                onTap: () async {
                  Get.to(const TeacherScoreboardPage());
                },
